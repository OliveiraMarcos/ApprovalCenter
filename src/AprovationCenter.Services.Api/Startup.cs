...
using MediatR;
using System;
using AprovationCenter.Infra.CrossCutting.Identity.Data;
...
using AprovationCenter.Infra.CrossCutting.IoC;
using Swashbuckle.AspNetCore.Swagger;

namespace AprovationCenter.Services.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                ...
                {
                    Version = "v1",
                    Title = "AprovationCenter Project",
                    Description = "AprovationCenter API Swagger surface",
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(s =>
            {
                s.SwaggerEndpoint("/swagger/v1/swagger.json", "AprovationCenter Project API v1.1");
            });
        }
